...
public class OpenLock {
    public static void main(String [] args) {
        int res = open("0000", new String [] {"0201","0101","0102","1212","2002"}, "0202");
        System.out.println(res);

        res = open("0000", new String [] {"8888"}, "0009");
        System.out.println(res);

        res = open("0000", new String [] {"8887","8889","8878","8898","8788","8988","7888","9888"}, "8888");
        System.out.println(res);
    }

    private static int open(String start, String [] deadends, String target) {
    ...
    private static List<int []> getChildren(int [] lock) {
    ...
    private static int [] getLock(String lock, int steps) {
        return new int [] {Character.getNumericValue(lock.charAt(0)), Character.getNumericValue(lock.charAt(1)),
                Character.getNumericValue(lock.charAt(2)), Character.getNumericValue(lock.charAt(3)), steps};
    }

    private static String toString(int [] lock) {
       StringBuilder res = new StringBuilder();

       res.append(String.valueOf(lock[0]));
       res.append(String.valueOf(lock[1]));
       res.append(String.valueOf(lock[2]));
       res.append(String.valueOf(lock[3]));
